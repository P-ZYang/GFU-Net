...
# from model.SCTransNet import Ours as SCTransNet
# from model.UNet.model_Unet import UNet as unet
# from loss import *
...
parser.add_argument("--pth_dirs", default=['NUDT/Ours_509_best.pth.tar'], type=list)
...
parser.add_argument("--save_log", type=str, default=r'./P(32)/', help="path of saved .pth")
...
def test():
    ...
    # CPU
    net = Ours(config_vit, mode='test', deepsuper=True)
    # net = unet(1, 1)
